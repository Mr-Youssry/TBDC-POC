...
| BL-002 | GitHub remote not created                 | The GitHub PAT in global CLAUDE.md (`ghp_ilRV68...`) returned "Bad credentials" when trying to create the remote repo. Local git is fine. Need Ahmed to either generate a new PAT or create the repo manually in the browser, then add the remote and push. | Medium   |
