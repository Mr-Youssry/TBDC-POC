 ...
 */
export function makePrisma(databaseUrl) {
    if (!databaseUrl) {
        throw new Error("[tbdc-db] makePrisma: databaseUrl is empty — refusing to build a PrismaClient without a connection string.");
    }
