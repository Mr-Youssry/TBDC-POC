...
export function registerUpdateCompany(api, prisma, deps) {
    api.registerTool({
        name: "update_company",
        label: "Update Company",
        description: "Update editable fields on a TBDC portfolio Company row. Does NOT touch id/cohort/name/sortOrder. Requires actingUserId. Wraps the write + audit insert in a transaction.",
        parameters: {
            type: "object",
            properties: {
