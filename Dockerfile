...
# Full node_modules from builder — needed for:
#   1) prisma db push / prisma db seed (prisma CLI + all transitive deps)
#   2) Next.js standalone references to externalized packages
# A future optimization can prune to only the prod deps needed.
